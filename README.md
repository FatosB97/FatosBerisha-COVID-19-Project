...
In case it is negative the patient will be discharged with the help of the  function [discharge()](#dischargepat_id-facility_id) .
...
By using the function [totalCapacityLeftInAllFacilities](#totalcapacityleftinallfacilitiesfacilitytype) will be able to know if there is enough joint capacity in the other quarantines.
	If there is:
